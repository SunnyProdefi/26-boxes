...
- 开箱反馈：箱子弹开、金额板划除，并根据开出金额播放不同情绪的短音效。
- 报价反馈：银行家报价出现时，报价面板会以电话来电形式闪动并播放铃声音效。
- 决策反馈：Deal、No Deal、最终保留或交换都有独立音效和面板动画。
- 最终揭晓：中奖箱高亮，并出现短暂奖花动画；高额奖金会触发更强的揭晓反馈。
- 音效开关：顶部提供音效开关，玩家选择会保存在本地浏览器中。
- 无障碍：动画尊重系统 `prefers-reduced-motion` 设置。
